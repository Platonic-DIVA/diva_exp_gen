with open("mmdcommands.csv") as mmd_expressions:
    for line in mmd_expressions:
            ...
            if Name == "まばたき": # Eye blink
                if Value >= 1:
                    output_command = str("TIME(" + str(int(Time)) + "); \n" + "EXPRESSION(0, 22, " + "50, " + str(str(round(FrameValue))) + ");")
                    print(output_command)
                if Value <= 0:
                    output_command = str("TIME(" + str(int(Time)) + "); \n" + "EXPRESSION(0, 21, " + "50" + ", 0);")
                    print(output_command)
            if Name == "感嘆":
                if Value >= 1:
            ...
            if Name == "ウツロ":
                ...
                if Value <= 0:
                    output_command = str("TIME(" + str(int(Time)) + "); \n" + "EXPRESSION(0, 21, " + "50" + ", 0);")
                    print(output_command)
            if Name == "ｳｨﾝｸ２右": # Wink_R
                if Value >= 1:
                    output_command = str("TIME(" + str(int(Time)) + "); \n" + "EXPRESSION(0, 43, " + "50, " + str(str(round(FrameValue))) + ");")
                    print(output_command)
                if Value <= 0:
                    output_command = str("TIME(" + str(int(Time)) + "); \n" + "EXPRESSION(0, 21, " + "50" + ", 0);")
                    print(output_command)
            if Name == "ウィンク２": #Wink_L
                if Value >= 1:
                    output_command = str("TIME(" + str(int(Time)) + "); \n" + "EXPRESSION(0, 42, " + "50, " + str(str(round(FrameValue))) + ");")
                    print(output_command)
                if Value <= 0:
                    output_command = str("TIME(" + str(int(Time)) + "); \n" + "EXPRESSION(0, 21, " + "50" + ", 0);")
                    print(output_command)
            if Name == "ウィンク右": #PerkyWink_R
                if Value >= 1:
                    output_command = str("TIME(" + str(int(Time)) + "); \n" + "EXPRESSION(0, 45, " + "50, " + str(str(round(FrameValue))) + ");")
                    print(output_command)
                if Value <= 0:
                    output_command = str("TIME(" + str(int(Time)) + "); \n" + "EXPRESSION(0, 21, " + "50" + ", 0);")
                    print(output_command)
            if Name == "ウィンク": #PerkyWink_L
                if Value >= 1:
                    output_command = str("TIME(" + str(int(Time)) + "); \n" + "EXPRESSION(0, 44, " + "50, " + str(str(round(FrameValue))) + ");")
                    print(output_command)
                if Value <= 0:
                    output_command = str("TIME(" + str(int(Time)) + "); \n" + "EXPRESSION(0, 21, " + "50" + ", 0);")
                    print(output_command)
            ...
            if Name == "う": # Mouth_U
                ...
                if Value <= 0:
                    output_command = str("TIME(" + str(int(Time)) + "); \n" + "MOUTH_ANIM(0, 0, 8, " + "100" + ", 1000);")
                    print(output_command)
            if Name == "にやり": # Mouth_Grin
                if Value >= 1:
                    output_command = str("TIME(" + str(int(Time)) + "); \n" + "MOUTH_ANIM(0, 0, 6, " + "100" + ", 1000);")
                    print(output_command)
                if Value <= 0:
                    output_command = str("TIME(" + str(int(Time)) + "); \n" + "MOUTH_ANIM(0, 0, 8, " + "100" + ", 1000);")
                    print(output_command)
